...
int main(int argc, char *argv[]) {
    ...
    uint16_t numberOfUes = 100; //VEÍCULOS

    uint16_t numberOfRsus = 0; //RSU
...
//   request_service(ueNodes.Get(i), ueNodes.Get(1));
...
//      ApplicationContainer apps = server.Install(ueNodes.Get(1));
